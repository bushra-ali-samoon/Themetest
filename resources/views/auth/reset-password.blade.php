        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" method="POST" action="{{ route('password.update') }}">
                            ...
                            <!-- Required hidden field for token -->
                            ...
                            <div class="fv-row mb-8">
                                <input type="email" name="email" value="{{ old('email', request('email')) }}"
                                       class="form-control bg-transparent" placeholder="Email" required readonly />
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <input type="password" name="password_confirmation"
                                       class="form-control bg-transparent" placeholder="Confirm New Password" required />
                            </div>
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100 text-center">
                    ...
                    <h1 class="text-white fs-2qx fw-bolder mb-7">Secure Password Reset</h1>
                    <div class="text-white fs-base opacity-75">
                        Enter your new password and access your account again.
                    </div>
                </div>
            </div>
